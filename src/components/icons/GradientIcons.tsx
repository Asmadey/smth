...
export const TelegramIcon = () => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g filter="url(#glow_telegram)">
      <path d="M40 8L6 22l10 4 4 12 6-6 8 6L40 8z" fill="url(#grad_telegram)" opacity="0.95"/>
      <path d="M30 18L18 30M20 26l-4 8 4-12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </g>
  </svg>
);
